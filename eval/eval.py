...
def generate(caption, wordtoix, ixtoword, text_encoder, netG, blob_service, copies=2):
    ...
    container_name = "rhinoooo"
    full_path = "https://rhinooo.blob.core.windows.net/rhinoooo/%s"
...
def eval(caption):
    ...
    # load blob service
    blob_service = BlockBlobService(account_name='rhinooo', account_key=os.environ["BLOB_KEY"])
